...
namespace OpenTelemetry.Trace
{
    ...
    {
        /// <summary>
        /// A blank <see cref="SpanContext"/> used with the BlankSpan.
        /// </summary>
        internal static readonly SpanContext BlankContext = new SpanContext(default, default, ActivityTraceFlags.None);
